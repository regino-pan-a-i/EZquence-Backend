...
processController.updateProcessMaterial = async (req, res, next) => {
    try{
        ...
        let data = await materialModel.updateMaterialListByMaterialId(processId, materialId, editedMaterial);
...
processController.deleteMaterialFromMaterialList = async (req, res, next) => {
    try {
        ...
        let data = await materialModel.deleteMaterialFromMaterialList(processId, materialId);

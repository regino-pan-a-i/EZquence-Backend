...
router.get('/', util.verifyUser, util.verifyWorker, inventoryController.getMaterialList);
...
// Create Material
router.post('/createMaterial', util.verifyUser, inventoryController.createMaterial);
...
router.put('/:id/adjust', util.verifyUser, inventoryController.adjustMaterialQuantity);
...
router.delete('/:id/delete', util.verifyUser, inventoryController.deleteMaterial);
